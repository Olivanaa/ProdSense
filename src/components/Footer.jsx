            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        <div className="text-2xl font-bold mb-4 font-title">PRODSENSE</div>
                        <p className="text-gray-400 mb-6 max-w-md">
                            Plataforma inteligente de monitoramento ambiental que combina IoT e IA
                            para promover bem-estar, conforto e produtividade no ambiente de trabalho.
                        </p>
                            ...
                            <a href="#" className="text-gray-400 hover:text-white transition-colors">
                                ...
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path 
                                        ...
                                        2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761
                                        -2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Sensores IoT</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Índice de Conforto</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Recomendações IA</a></li>
                        </ul>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm">
                        &copy; 2025 ProdSense. Todos os direitos reservados.
                    </p>
